...
#import "ScottCaputureController.h"
#import <AVFoundation/AVFoundation.h>

@interface ScottCaputureController ()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate>
...
@implementation ScottCaputureController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"切换摄像头" style:UIBarButtonItemStyleDone target:self action:@selector(toggleCapture)];
